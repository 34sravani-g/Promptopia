...
/* Defined the PromptCardProps interface to type the props for the component.
Specified the types for the post object and other props.
Used React.FC<PromptCardProps> to define the component type. */